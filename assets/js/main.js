...
(function () {
  ...
  var I18N = {
    ja: {
      ...
      'why.title': 'なぜ、「声」なのか',
      'why.statement': '写真も文字も残る<br>でも、その時の気持ちは、<br class="br-sp">残りにくい',
      'why.keepLabel': '残るもの',
      'why.keepBody': 'スマートフォンには写真や動画が残る<br>SNSには投稿が残る<br>出来事の記録はいくつも積み重なっていく',
      ...
      'why.voice': '写真や動画にはその瞬間の景色や姿を残せます。一方で自分の気持ちや、まだ言葉になりきっていない想いを残したいとき、カメラに向かって話すのは少し照れくさく感じることもあります。声なら誰かに見せるためではなく、自分に話しかけるように、その時の感情を自然に残せます。',
      ...
      'whyNow.g3': '<span class="ln">そして人といつでもつながれる時代になっても、</span><span class="ln">本当に伝えたい気持ちまで、いつも伝えられているとは限りません。</span>',
      ...
      'whyNow.g5': '<span class="ln">けれど自分の気持ちを理解することや、</span><span class="ln">大切な人と心を深く通わせることは、</span><span class="ln">便利さだけでは生まれません。</span>',
      ...
      'philosophy.b1.body': '日々の感情や出来事を残し、振り返ることで自分が何を感じ、何を大切にし、どのように変化しているのかに気づいていく。',
      'philosophy.b2.title': '人とのつながり',
      'philosophy.b2.body': '普段は言葉にできない感謝や愛情、励ましや想いを声にして届けることで、すでにそこにある大切な関係をさらに深めていく。',

      'voiceAlbum.title': '<span class="ph">その瞬間の気持ちを</span><span class="ph">残しておく</span>',
      'voiceAlbum.visualAlt': '声と写真で日々の気持ちを残す時間を表したイメージ',
      ...
      'weeklyReflection.visualAlt': '一日の終わりに自分自身を静かに振り返る時間を表したイメージ',
      'weeklyReflection.p1': '<span class="ln">Weekly ReflectionではAIが1週間に残された声や感情を横断して振り返ります。</span>',
      'weeklyReflection.pts': '<span class="ln"><span class="ph">繰り返し現れる</span><span class="ph">感情や出来事</span></span><span class="ln"><span class="ph">大切にしている</span><span class="ph">価値観</span></span><span class="ln"><span class="ph">日々の中では</span><span class="ph">気づきにくい小さな変化</span></span>',
      'weeklyReflection.p2': '<span class="ln">MusuhiではAIを診断や評価、正解を与えるために使うのではなく、</span>',
      ...
      'connection.gift.b1': 'Voice Letterでは大切な人へ、普段はなかなか言葉にできない想いを、自分自身の声で届けます。',
      'connection.gift.pts': '<span class="ln"><span class="ph">感謝</span></span><span class="ln"><span class="ph">励まし</span></span><span class="ln"><span class="ph">愛情</span></span><span class="ln"><span class="ph">尊敬</span></span><span class="ln"><span class="ph">文字だけでは</span><span class="ph">伝えきれない想い</span></span>',
      ...
      'connection.book.b1': 'Voice Bookでは家族や友人、仲間たちの声と写真、思い出をひとつに集め、',
      ...
      'vision.v4': '<span class="ln">Musuhiはそんな未来を描いています。</span>',
      ...
      'vision.v6': '<span class="ln">そうした体験を通じて、</span><span class="ln">Musuhiは心の豊かさとウェルビーイングに貢献していきたいと考えています。</span>',
      ...
      'appExperience.moreEyebrow': '使い続けるほど育っていく',
      'appExperience.moreLead': '残した声はひとつのMomentとして<br class="br-sp">形に残り、積み重ねるほど育っていきます',
      ...
      'story.p1': '私の父は幼い頃の私へ向けて、「敏康 成長記」と書かれたカセットテープを残してくれていました。',
      'story.p2': 'そこには写真では伝わらない——父の声、笑い方、話す間、その時の感情や想いが、そのまま残っていました。',
      'story.quote1': '声にはその人の想いまで残る',
      'story.quote2': '人は直接面と向かっては言わないことでも、<br>何かを媒介することで伝えやすくなる',
      'story.p3': '年月が経ってからその声を聞いたとき、懐かしさとあわせて父の想いや、自分が大切にされていたことまで伝わってくるように感じました。',
      'story.p4': '声は時間が経ってもその人の気持ちまで残してくれる。',
      'story.p5': 'そして声には人の心を支え、前を向く力をくれることがあるのだと感じたことを、今でも覚えています。',
      'story.origin': 'この体験がMusuhiの原点です',
      'story.signature': 'Musuhi　中村敏康',

      'ctaFinal.title': '今日、あなたの心が<br class="br-sp">動いた瞬間は？',
      'ctaFinal.list': '嬉しかったこと　感謝したこと　挑戦したこと　心が少し揺れたこと',
      'ctaFinal.lead': 'その瞬間を声と写真で残してみませんか<br>今日の気持ちをあなたの最初のMomentとして残せます',
      'ctaFinal.button': 'App StoreでMusuhiをはじめる',
      'ctaFinal.buttonHref': 'https://apps.apple.com/jp/app/musuhi/id6808240697',
      'ctaFinal.brandLine': '声からはじまる自分との対話　人とのつながり',
      ...
      'meta.title': 'Musuhi — その瞬間の気持ちを声と写真で残す。| One Moment. One Voice.',
      'meta.description': 'Musuhiはその時に感じた気持ちや頭に浮かんだ感情を声と写真で残し、AIで振り返り、大切な人にも贈れるライフログサービスです。',
    ...
    en: {
      ...
      'voiceAlbum.visualAlt': 'A quiet moment of preserving a feeling in voice and photo',
      ...
      'weeklyReflection.visualAlt': 'A quiet moment of looking back on the week at day’s end',
